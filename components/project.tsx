...
export default function Project({
  ...
  return (
    ...
    >
      ...
      sm:min-h-[20rem] hover:bg-gray-200 transition sm:group-even:pl-8 dark:text-white dark:bg-white/10 dark:hover:bg-white/20">
        ...
        <div className="absolute hidden sm:block top-8 -right-40 w-[32rem] h-[18rem] 
